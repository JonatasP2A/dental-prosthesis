...
## 12. Testing
- [ ] 12.1 Write unit tests for Client domain entity (90%+ coverage)
- [ ] 12.2 Write unit tests for Client use cases (90%+ coverage)
- [ ] 12.3 Write unit tests for Client HTTP handlers
- [ ] 12.4 Write unit tests for Order domain entity (90%+ coverage)
- [ ] 12.5 Write unit tests for Order use cases (90%+ coverage)
- [ ] 12.6 Write unit tests for Order HTTP handlers
- [ ] 12.7 Write integration tests for Client repository
- [ ] 12.8 Write integration tests for Order repository
- [ ] 12.9 Write integration tests for Client HTTP endpoints
- [ ] 12.10 Write integration tests for Order HTTP endpoints
- [ ] 12.11 Test laboratory-scoped access control
- [ ] 12.12 Test order status workflow transitions
